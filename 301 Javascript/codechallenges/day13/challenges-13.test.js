...
const standardizePhoneNumbers = (arr) => {
  ...
  const numbers = arr.map(value => {
      let total2 = `${value.split('(')[1].split(')')[0]}${value.split('(')[1].split(')')[1].split(' ')[1].split('-')[0]}${value.split('(')[1].split(')')[1].split(' ')[1].split('-')[1]}`
    //   ${value.split('(')[1].split(')')[1].split('-')[0]}${value.split('(')[1].split(')')[1].split('-')[1]}`;
