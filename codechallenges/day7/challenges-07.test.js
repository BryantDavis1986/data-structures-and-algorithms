...
Write a function named forLoopTwoToThe that, given an array of integers as input, iterates over the array and returns a new array. The returned array should contain the result of raising 2 
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  const results = arr.map((value, index) => {
