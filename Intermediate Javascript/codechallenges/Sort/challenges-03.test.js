...
const alphabetizeBetter = (arr) => {
  // Solution code here...
  arr.sort((num1, num2) => {
    if(num1.toLowerCase() < num2.toLowerCase()){
      return -1 
    } else if (num1.toLowerCase() > num2.toLowerCase()){
      return 1 
    } else { 
      return 0; 
    }
...
Write a function named sortPeople that takes in an array of Person objects, each of which has firstName, lastName, and age properties, and sorts 
those people by their last names. Do not worry about capitalization or first names.
------------------------------------------------------------------------------------------------ */
...
const sortPeople = (arr) => {
  // Solution code here...
  arr.sort((num1, num2) => {
    if(num1.lastName < num2.lastName){
      return -1 
    } else if (num1.lastName > num2.lastName){
      return 1 
    } else { 
      return 0; 
    }
  ...
  arr.sort((num1, num2) => {
    if(num1.lastName < num2.lastName){
      ...
      return 1 
        ...
        if(num1.firstName < num2.firstName){
            return -1 
          } else if (num1.firstName > num2.firstName){
            return 1 
          } else { 
...
Write a function named sortMeetingsByDay that takes in an array of objects, each of which represents a meeting happening a particular day
 of the week, with a particular start time and end time.

Sort the meetings by the day on which they happen, Monday-Friday. It does not matter which order meetings come in on a particular day. For example,
...
const sortMeetingsByDay = (arr) => {
  ...
  arr.sort((num1, num2) => {
    if(num1.dayOfWeek.getDay() < num2.dayOfWeek.getDay()){
      return -1 
    } else if (num1.dayOfWeek.getDay() > num2.dayOfWeek.getDay()){
      return 1 
    } else { 
      return 0; 
    }
