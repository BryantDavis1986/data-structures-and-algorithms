...
Write a function named isNum that takes in a string or number of any length. This function should use a regular expression pattern to return true if the input contains a number, and false if the 
...
Write a function named citiesAtoJ that takes in an array of city names and uses a regular expression pattern to return a new array containing any 
...
const matchMonth = (input) => {
  // Solution code here...
  const regex = /\b(October|Oct|october|oct)\b/g;
  return regex.test(input);
};
